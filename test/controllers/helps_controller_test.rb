...
class HelpsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create help" do
    assert_difference('Help.count') do
      post helps_url, params: { help: { category: @help.category, content: @help.content, title: @help.title } }
    end
  ...
  test "should update help" do
    patch help_url(@help), params: { help: { category: @help.category, content: @help.content, title: @help.title } }
